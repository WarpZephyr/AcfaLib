...
static void PatchWorker(uint64_t arg)
{
...
bool Start()
{
    ...
    return sys_ppu_thread_create(&thread_id, PatchWorker, 0, priority, stack_size, flags, "AcfaLib::CellFsHook::PatchWorker") == CELL_OK;
}
